package com.ggingmin.license.service;
...
public class LicenseService {
    ...
    public License getLicense(String licenseId, String organizationId) {
        ...
        license.setDescription("SW Product");
        license.setProductName("ggingStock");
    ...
    public String createLicense(License license, String organizationId, Locale locale) {
        ...
        if (license != null) {
            license.setOrganizationId(organizationId);
            responseMessage = String.format(messages.getMessage("license.create.message", null, null), license.toString());
        }
